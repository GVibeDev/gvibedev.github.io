...
links:
  launchUrl: https://pizza-990.github.io/black-white-survivors/
pageReady: true
...
The V0.8a milestone adds a separately hosted **single-player online runtime** on BiggityKot's GitHub Pages. The downloadable 0.9A archive remains available for the complete local package, including its Node-based LAN path.
